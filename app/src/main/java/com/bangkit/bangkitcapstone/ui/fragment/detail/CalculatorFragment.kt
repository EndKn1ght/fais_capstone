...
import com.bangkit.bangkitcapstone.databinding.FragmentCalculatorIntakeBinding
...
class CalculatorFragment : Fragment() {
    ...
    private var _binding: FragmentCalculatorIntakeBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCalculatorIntakeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onResume() {
        ...
        val arrayAdapter = ArrayAdapter(requireContext(), R.layout.drop_item_options, activities)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.caloriesButton.setOnClickListener {
            ...
            if (weightInput.isNotEmpty() && heightInput.isNotEmpty() && ageInput.isNotEmpty()) {
                ...
                val water = viewModel.waterCalculator(weight)
        ...
        viewModel.getAllUserData().observe(viewLifecycleOwner) { dataMap ->
            ...
            binding.autoCompleteTextView.text =
                Editable.Factory.getInstance().newEditable(dataMap["activity"])
